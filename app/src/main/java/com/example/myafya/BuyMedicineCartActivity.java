...
public class BuyMedicineCartActivity extends AppCompatActivity {
    ...
    private Button dateButton2,btnCheckoutBM;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartBM = findViewById(R.id.imageViewBMCartBack);
        dateButton2 = findViewById(R.id.buttonBMCartDate);
        btnCheckoutBM = findViewById(R.id.buttonBMCartCheckout);
        ...
        cartBM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BuyMedicineCartActivity.this,BuyMedicineActivity.class));
            }
        });
        btnCheckoutBM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(BuyMedicineCartActivity.this,BuyMedicineBookActivity.class);
                it.putExtra("price",tvTotal.getText());
                it.putExtra("date",dateButton2.getText());
                startActivity(it);
            }
        });
        //datepicker
